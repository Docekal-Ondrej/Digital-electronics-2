...
| Timer/Counter1 | 16 | 4096u | 32768u | -- | 262144u | -- | 1,049s | 4,19s |
...
Functions are executed in particular order as the program runs, while interrupt can occur anytime because it is caused by external signal.
